...
class PsGui:
    ...
    def launch_cmds(self, cmd):
        if cmd == b'sa' and len(self.a) >= 2:
            self.a[0], self.a[1] = self.a[1], self.a[0]
        if cmd == b'sb' and len(self.b) >= 2:
        ...
        if cmd == b'ss':
            ...
            if (len(self.b) >= 2):
                self.b[0], self.b[1] = self.b[1], self.b[0]
        if cmd == b'ra' and len(self.a) >= 2:
            self.a.append(self.a[0])
            del self.a[0]
        if cmd == b'rb' and len(self.b) >= 2:
        ...
        if cmd == b'rr':
            ...
            if (len(self.b) >= 2):
                self.b.append(self.b[0])
                del self.b[0]
        if cmd == b'rra' and len(self.a) >= 2:
            self.a = [self.a[-1]] + self.a
            del self.a[-1]
        if cmd == b'rrb' and len(self.b) >= 2:
        ...
        if cmd == b'rrr':
            ...
            if (len(self.b) >= 2):
                self.b = [self.b[-1]] + self.b
                del self.b[-1]
        if cmd == b'pa' and len(self.b) >= 1:
            self.a = [self.b[0]] + self.a
            del self.b[0]
        if cmd == b'pb' and len(self.a) >= 1:
            self.b = [self.a[0]] + self.b
            del self.a[0]
    ...
    def draw_rectangles(self):
        ...
        wh = 600
        hw = ww / 2
        hm = len(self.a) + len(self.b)
        mx, mn = (0, 0)
        if (hm != 0):
            mx = max(self.a + self.b)
            mn = min(self.a + self.b)
        rects = []
        if len(self.a) > 0:
            a_val = [(data - mn) / (mx - mn) for data in self.a]
            for vala in a_val:
        ...
        vi = 0
        if len(self.b) > 0:
            b_val = [(data - mn) / (mx - mn) for data in self.b]
            for valb in b_val:
